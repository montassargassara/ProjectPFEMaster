...
public class SaleValidationRequestDTO {
    ...
    public static SaleValidationRequestDTO from(SaleValidationRequest r, String apiBase) {
        ...
        if (r.getProperty() != null) {
            ...
            dto.setPropertyTitre(r.getProperty().getTitre());
            ...
            dto.setPrixVente(r.getProperty().getPrixVente());
            dto.setPrixLocation(r.getProperty().getPrixLocation());
            if (r.getProperty().getMainImageId() != null) {
                dto.setMainImageUrl(apiBase + "/api/images/public/" + r.getProperty().getMainImageId());
            }
        }
